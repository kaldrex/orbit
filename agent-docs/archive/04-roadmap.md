...
> **Archived 2026-04-20. Superseded by the 8-stage post-V0 roadmap in [14-cleanup-2026-04-20.md](../14-cleanup-2026-04-20.md) + [15-future-props.md](../15-future-props.md).** The 6-track model below is historical — Tracks 1/2 landed, Track 3's "packet assembler + golden-packet diff-clean" target was abandoned in favor of the V0 observer → basket → resolver → card pipeline. Track 4's "LLM enrichment" happened as Stage 6-v3/v4 at much smaller cost (~$8.55) than the pre-V0 $520/founder/year budget. Do not plan new work against this doc.
>
