...
2. [14-cleanup-2026-04-20.md](./14-cleanup-2026-04-20.md) — The audit + four-phase cleanup. **329 tests green. DB is 1,602 clean persons. Enriched endpoint live. Umayr byte-identical across every change.** What's built, what the debt is.
...
9. [01-vision.md](./01-vision.md) + [02-architecture.md](./02-architecture.md) — Product frame + current 5-contract architecture.
...
| [14-cleanup-2026-04-20.md](./14-cleanup-2026-04-20.md) | **Starting a new session.** Post-cleanup state. | audit · wipe + re-ingest · safety rules · enriched endpoint · 329 tests · 1602 persons |
...
| [02-architecture.md](./02-architecture.md) | Touching schema, routes, projection, identity, LLM split | 5 contracts · observations basket · card assembler · rules-as-tools |
